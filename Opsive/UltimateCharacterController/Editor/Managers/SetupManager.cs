    ...
    public class SetupManager : Manager
    {
        ...
        private void DrawSceneSetup()
        {
            ...
            ManagerUtility.DrawControlBox("Camera Setup", DrawCameraViewTypes, "Sets up the camera within the scene to use the Ultimate Character Controller Camera Controller component.",
                                                true, "Setup Camera", SetupCamera, string.Empty);
        ...
        private void SetupCamera()
        {
            ...
            if (cameraGameObject.GetComponent<CameraController>() == null) {
                ...
                if (m_Perspective != Perspective.First) {
                    AddComponent<ThirdPersonController.Camera.ObjectFader>(cameraGameObject);
                }
#endif
        ...
        private void AddManagers()
        {
            ...
            if (gameGameObject.GetComponent<DeterministicObjectManager>() == null) {
                AddComponent<DeterministicObjectManager>(gameGameObject);
            }
        ...
        private void AddUI()
        {
            ...
            var baseDirectory = System.IO.Path.GetDirectoryName(AssetDatabase.GetAssetPath(MonoScript.FromScriptableObject(m_MainManagerWindow))).Replace(@"Editor\Managers", "");
            var uiPrefab = AssetDatabase.LoadAssetAtPath(baseDirectory + "Demo/Prefabs/UI/Monitors.prefab", typeof(GameObject)) as GameObject;
            if (uiPrefab == null) {
        ...
        private void AddVirtualControls()
        {
            ...
            var virtualControlsPrefab = AssetDatabase.LoadAssetAtPath(baseDirectory + "Demo/Prefabs/UI/VirtualControls.prefab", typeof(GameObject)) as GameObject;
